...
<!-- [![My web link](https://skillicons.dev/icons?i=codepen)](https://codepen.io/ang-dev) -->
...
Currently upskilling in Software Architecture patterns by architecting and maintaining a self-hosted Home Lab environment on Raspberry Pi. This sandbox allows me to experiment with network security, containerization, and system design in a controlled Linux environment.
